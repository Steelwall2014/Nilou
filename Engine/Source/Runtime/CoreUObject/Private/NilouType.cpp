...
IMPLEMENT_FIELD(FMathProperty)
IMPLEMENT_FIELD(FVectorProperty)
IMPLEMENT_FIELD(FQuatProperty)
IMPLEMENT_FIELD(FRotatorProperty)
IMPLEMENT_FIELD(FTransformProperty)
IMPLEMENT_FIELD(FBoxProperty)
IMPLEMENT_FIELD(FBoxSphereBoundsProperty)
