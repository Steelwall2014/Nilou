...
layout(std430, set=SET_INDEX, binding=BINDING_INDEX) readonly buffer NodeListBuffer{
    uvec4 NodeList[];
};
...
layout(std430, set=SET_INDEX, binding=BINDING_INDEX) readonly buffer LODParamsBuffer{
