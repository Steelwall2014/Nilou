...
namespace und {
	...
	void RHISetShaderImage(FRHIGraphicsPipelineState *, int32 BaseIndex, RHITexture *, EDataAccessFlag AccessFlag)
    {
	...
	void RHISetDepthStencilState(RHIDepthStencilState *newState, uint32 StencilRef)
    {
    ...
    */
	...
	void RHIDrawArrays(uint32 Count, int32 InstanceCount)
    {
	...
	void RHIDrawIndexed(RHIBuffer *IndexBuffer, int32 InstanceCount)
    {
