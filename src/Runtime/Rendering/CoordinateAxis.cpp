...
CoordinateAxis::CoordinateAxis(float length, float width)
{
	...
	glBufferData(GL_ARRAY_BUFFER, 6 * sizeof(FVector3f), x_axis, GL_STATIC_DRAW);
	...
	glBufferData(GL_ARRAY_BUFFER, 6 * sizeof(FVector3f), x_axis2, GL_STATIC_DRAW);
	glEnableVertexAttribArray(Position_location);
	glVertexAttribPointer(Position_location, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float), 0);
	glBindVertexArray(0);
	...
	glBufferData(GL_ARRAY_BUFFER, 6 * sizeof(FVector3f), y_axis, GL_STATIC_DRAW);
	glEnableVertexAttribArray(Position_location);
	glVertexAttribPointer(Position_location, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float), 0);
	glBindVertexArray(0);
	...
	glBufferData(GL_ARRAY_BUFFER, 6 * sizeof(FVector3f), y_axis2, GL_STATIC_DRAW);
	glEnableVertexAttribArray(Position_location);
	glVertexAttribPointer(Position_location, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float), 0);
	glBindVertexArray(0);
	...
	glBufferData(GL_ARRAY_BUFFER, 6 * sizeof(FVector3f), z_axis, GL_STATIC_DRAW);
	glEnableVertexAttribArray(Position_location);
	glVertexAttribPointer(Position_location, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float), 0);
	glBindVertexArray(0);
	...
	glBufferData(GL_ARRAY_BUFFER, 6 * sizeof(FVector3f), z_axis2, GL_STATIC_DRAW);
	glEnableVertexAttribArray(Position_location);
	glVertexAttribPointer(Position_location, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float), 0);
	glBindVertexArray(0);
