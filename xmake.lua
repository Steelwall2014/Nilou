...
includes("External/microprofile/xmake.lua")
includes("External/stb_image/xmake.lua")
includes("External/tinygltf/xmake.lua")
includes("External/json/xmake.lua")
includes("External/tiny3dtiles/xmake.lua")
